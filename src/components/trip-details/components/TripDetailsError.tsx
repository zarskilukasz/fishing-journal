/**
 * TripDetailsError - Error display for trip details view.
 * Shows error message with options to retry or go back.
 */
import React from "react";
import { AlertCircle, RefreshCw, ArrowLeft } from "lucide-react";
import { Button } from "@/components/ui/button";
import type { TripDetailsErrorProps } from "../types";

/**
 * Error state component with retry and navigation functionality.
 */
export function TripDetailsError({ error, onRetry }: TripDetailsErrorProps) {
