...
/**
 * GET /api/v1/groundbaits
 *
 * Lists all groundbaits with optional filtering, pagination, and sorting.
 * Requires authentication. Returns only groundbaits belonging to the authenticated user.
 *
 * Query parameters:
...
/**
 * POST /api/v1/groundbaits
 *
 * Creates a new groundbait.
 * Requires authentication. The groundbait is automatically associated with the authenticated user.
 *
 * Request body:
