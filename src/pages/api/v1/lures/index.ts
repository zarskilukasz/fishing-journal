 ...
 * GET /api/v1/lures
 *
 * Lists all lures with optional filtering, pagination, and sorting.
 * Requires authentication. Returns only lures belonging to the authenticated user.
 *
 * Query parameters:
 ...
 *
 * Creates a new lure.
 * Requires authentication. The lure is automatically associated with the authenticated user.
 *
 * Request body:
