...
import { createLuresService } from "@/lib/services/equipment.service";
import { createErrorResponse, createSuccessResponse, createNoContentResponse } from "@/lib/api/error-response";

/**
 * GET /api/v1/lures/{id}
 *
 * Gets a single lure by ID.
 * Requires authentication. Returns 404 if the lure doesn't exist or belongs to another user.
 *
 * Path parameters:
 * - id: UUID of the lure
 */
...
/**
 * PATCH /api/v1/lures/{id}
 *
 * Updates an existing lure (partial update).
 * Requires authentication. Returns 404 if the lure doesn't exist or belongs to another user.
 *
 * Path parameters:
 * - id: UUID of the lure
...
/**
 * DELETE /api/v1/lures/{id}
 *
 * Soft-deletes a lure by setting deleted_at.
 * Requires authentication. Returns 404 if the lure doesn't exist or belongs to another user.
 *
 * Path parameters:
 * - id: UUID of the lure
